module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitles = ["【获奖公示】云阁绮霞 -王者荣耀风物志插画漫画大赛", "新皮肤爆料｜守护万千星河，云上仙君新装登场！", "顺风局主题语音票选活动结果公告", "这大唐盛世如你所愿 《乱世王者》喜迎公测三周年庆", "创意互动营互动小任务第三期开启公告", "12月8日碎片商店异常问题修复公告", "12月8日碎片商店异常问题说明", "12月8日全服不停机更新公告", "12月5日体验服停机更新公告", "嫦娥皮肤设计大赛正式开启！", "新英雄澜登场，冬日聚峡谷对战赢好礼", "王者创意互动周好礼来袭 云中君-纤云弄巧限时秒杀", "【手Q独家】商城限时免单", "感恩节快乐，参与活动领缤纷好礼", "挑战绝悟赢荣誉称号，S17赛季战令限时返场", "成都AG超玩会晋级决赛！12月19日会师DYG决战重庆，看谁能问鼎巅峰！", "决赛见！DYG力克成都AG，锁定总决赛名额！成都AG错失晋级掉入败者组", "第一视角进入教程，来营地看一诺、小义细微操作！见证决赛名额诞生！", "四强集结！12月4日季后赛第二周重庆开战，一起见证总决赛战队诞生！", "2020年KPL秋季赛常规赛最佳选手——DYG小义"]
    ...
    router.get('/news/list', async (req, res) => {
        ...
        const colors = [{ name: '新闻', color: '#1e96ab' }, { name: '公告', color: '#f09a37' }, { name: '活动', color: '#ff3636' }, { name: '赛事', color: '#4d9cff' }]
        cats.map(cat => {
            cat.newsList.map(news => {
                news.categoryName = cat.name === '热门' ? news.categories[0].name : cat.name
                colors.map(item => {
                    if (item.name === news.categoryName) {
